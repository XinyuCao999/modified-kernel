...
# -*- coding: utf-8 -*-
"""
Created on Mon Jul 21 18:44:11 2025
...
if __name__=='__main__':
    ...
    """
    test 3 different kind of GP models
    """
# =============================================================================
...
#     # mean3,std3=model_prediction(input_data,model3)
# =============================================================================
    
# =============================================================================
#     # initial_point_number=100
#     # input_data,output_data=initial_sampling_fun(initial_point_number)
#     compare=np.zeros([initial_point_number,2])
#     std=np.zeros([initial_point_number,2])
#     mean2,std2=model_prediction(input_data,model2) 
#     mean5,std5=model_prediction(input_data,model5)
#     compare[:,0]=abs(mean2.reshape(-1)-output_data)
#     compare[:,1]=abs(mean5.reshape(-1)-output_data)
#     std[:,0]=std2
#     std[:,1]=std5
#     
#     a_mean,a_std=model_prediction(optimal_input,model2) 
#     b_mean,b_std=model_prediction(optimal_input,model5) 
# =============================================================================
...
#     opt_info_dict=run_BO(model_type,initial_point_number,max_iter=1,acquisition_function="UCB",
#                           initial_sampling_fun=initial_sampling_fun,bounds=bounds,truth_ground=VDV_truth_ground,alpha=0.8,
#                           autostop_flag=False,machanistic_fun=prior_defult,beta=10,print_flag=False,read_sampling_index=0)
# =============================================================================
    ...
    res_dict_all=bo_result_statistics(model_type_list,BO_repete_num,initial_point_number,max_iter,acquisition_function,
                                      initial_sampling_fun=initial_sampling_fun,bounds=bounds,truth_ground=VDV_truth_ground,
                                      beta=2,print_flag=False,machanistic_fun=prior_defult,decay_factor=0.9)
