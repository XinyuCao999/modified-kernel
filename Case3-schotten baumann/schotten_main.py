# -*- coding: utf-8 -*-
"""
Created on Tue Jun 10 17:23:51 2025
...
from schotten_baumann_CSTR import initial_sampling_fun,truth_ground,bounds, x0_base,prior_defult
...
#                          initial_sampling_fun=initial_sampling_fun,bounds=bounds,truth_ground=truth_ground,alpha=0.8,
#                          autostop_flag=False,machanistic_fun=prior_defult,beta=10,print_flag=True)
# =============================================================================



    # model_type_list=["RBF_zeroprior","RBF_nonzeroprior","reconstructed","multi_fidelity"]
    ...
    res_dict_all=bo_result_statistics(model_type_list,BO_repete_num,initial_point_number,max_iter,acquisition_function,
                                      initial_sampling_fun=initial_sampling_fun,bounds=bounds,truth_ground=truth_ground,
