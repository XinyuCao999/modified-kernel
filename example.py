...
def plot_res(xs,ys,model1):
    ...
    if prior_info=="zeroprior":
        ...
        prior_info="dashed-line prior"
    ax.set_title('GP model ('+kernel_name+" kernel, "+prior_info+")", fontsize=20,fontname="Times New Roman")
    ax.set_xlabel('Design Space',fontsize=20,fontname="Times New Roman")
    ax.set_ylabel('Objective Value',fontsize=20,fontname="Times New Roman")
